...
/anaaexecute /command - Executes '/command' on all characters on the Actor network (including self)
/anzaexecute /command - Executes '/command' on all characters in the zone (including self)
/anzexecute /command - Executes '/command' on all characters in the zone (excluding self)
/angaexecute /command - Executes '/command' on all characters in the group (including self)
